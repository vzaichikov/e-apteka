        ...
        protected function getForm() {
            ...
            foreach ($banner_images as $key => $value) {
                foreach ($value as $banner_image) {
                    ...
                    if (is_file(DIR_IMAGE . $banner_image['image_mobil'])) {
                        $image_mobil = $banner_image['image_mobil'];
                        $thumb_mobil = $banner_image['image_mobil'];
                        } else {
                        $image_mobil = '';
                        $thumb_mobil = 'no_image.png';
                    }
                    ...
                    'thumb_mobil'       => $this->model_tool_image->resize($thumb_mobil, 100, 100),
