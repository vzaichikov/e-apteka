<?php
    class ControllerCatalogCategory extends Controller {
        ...
        protected function getForm() {
            ...
            $check = $this->model_design_banner->getBannersFromParent($this->request->get['category_id']);
            if(empty($check)){
                $data['is_attach_banner'] = 0;
                }else{
                $data['is_attach_banner'] = 1;
            }
            
            
            
            if (isset($this->request->post['category_banner'])) {
                $categories_banner = $this->request->post['category_banner'];
                } elseif (isset($this->request->get['category_id'])) {
                $categories_banner = $this->model_catalog_category->getCategoryBanners($this->request->get['category_id']);
                } else {
                $categories_banner = array();
            }
            
            $data['categories_banner'] = array();
            
            foreach ($categories_banner as $cat_id) {
                $cat_info = $this->model_catalog_category->getCategoryInfo($cat_id['category_id']);
			...
			if (isset($this->request->post['google_base_category_id'])) {
				$data['google_base_category_id'] = $this->request->post['google_base_category_id'];
				} elseif (!empty($category_info)) {
				$data['google_base_category_id'] = $category_info['google_base_category_id'];
				} else {
				$data['google_base_category_id'] = 0;
            }
			
			$data['google_base_category'] = $this->model_extension_feed_google_base->getGoogleBaseCategoryName($data['google_base_category_id']);
            ...
            if (isset($this->request->post['no_payment'])) {
                ...
                $data['no_payment'] = $category_info['no_payment'];
                } else {
                $data['no_payment'] = 0;
            }
            ...
            if (isset($this->request->post['no_shipping'])) {
                ...
                $data['no_shipping'] = $category_info['no_shipping'];
                } else {
                $data['no_shipping'] = 0;
            }
            ...
            if (isset($this->request->post['is_searched'])) {
                $data['is_searched'] = $this->request->post['is_searched'];
                } elseif (!empty($category_info)) {
                $data['is_searched'] = $category_info['is_searched'];
                } else {
                $data['is_searched'] = false;
            }
            
            if (isset($this->request->post['show_subcats'])) {
                $data['show_subcats'] = $this->request->post['show_subcats'];
                } elseif (!empty($category_info)) {
                $data['show_subcats'] = $category_info['show_subcats'];
                } else {
                $data['show_subcats'] = false;
            }
            ...
            if (isset($this->request->post['status_widget'])) {
                $data['status_widget'] = $this->request->post['status_widget'];
                } elseif (!empty($category_info)) {
                $data['status_widget'] = $category_info['status_widget'];
                } else {
        ...
        protected function validateForm() {
            ...
            if (isset($this->request->post['error_parent'])) {
                $this->error['warning'] = 'Сперва отсоедините эту категорию от родительской';
            }
            return !$this->error;
        }
