...
class ControllerLocalisationLocation extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['gmaps_link'])) {
			$data['gmaps_link'] = $this->request->post['gmaps_link'];
		} elseif (!empty($location_info)) {
		...
		if (isset($this->request->post['open_struct'])) {
			$data['open_struct'] = $this->request->post['open_struct'];
		} elseif (!empty($location_info)) {
			$data['open_struct'] = $location_info['open_struct'];
		} else {
			$data['open_struct'] = '';
		}
		...
		if (isset($this->request->post['delivery_times'])) {
			$data['delivery_times'] = $this->request->post['delivery_times'];
		} elseif (!empty($location_info)) {
			$data['delivery_times'] = $location_info['delivery_times'];
		} else {
			$data['delivery_times'] = '';
		}
		...
		if (isset($this->request->post['uuid'])) {
			...
			$data['uuid'] = $location_info['uuid'];
		} else {
			$data['uuid'] = '';
		}
		
		$data['nodes'] = $this->model_setting_nodes->getNodes();
		
		if (isset($this->request->post['node_id'])) {
			$data['node_id'] = $this->request->post['node_id'];
		} elseif (!empty($location_info)) {
			$data['node_id'] = $location_info['node_id'];
		} else {
			$data['node_id'] = 0;
		}
		
		if (isset($this->request->post['is_stock'])) {
			$data['is_stock'] = $this->request->post['is_stock'];
		} elseif (!empty($location_info)) {
		...
		if (isset($this->request->post['temprorary_closed'])) {
			$data['temprorary_closed'] = $this->request->post['temprorary_closed'];
		} elseif (!empty($location_info)) {
			$data['temprorary_closed'] = $location_info['temprorary_closed'];
		} else {
			$data['temprorary_closed'] = 0;
		}
		...
		if (isset($this->request->post['information_id'])) {
			...
			$data['information_id'] = $location_info['information_id'];
		} else {
			$data['information_id'] = 0;
		}
		
		if (isset($this->request->post['default_price'])) {
			$data['default_price'] = $this->request->post['default_price'];
		} elseif (!empty($location_info)) {
			$data['default_price'] = $location_info['default_price'];
		} else {
