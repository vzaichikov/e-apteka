		...
		public function index() {
			if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
				...
				if ($this->user->hasPermission('access', 'catalog/collection')) {
					$catalog[] = array(
					'name'	   => 'Коллекции',
					'href'     => $this->url->link('catalog/collection', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);
				}
				...
				if ($this->user->hasPermission('access', 'extension/module/price_control')) {
					$catalog[] = array(
					'name'	   => 'Массовое управление ценами',
					'href'     => $this->url->link('extension/module/price_control', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);
				}
				...
				if ($this->user->hasPermission('access', 'catalog/socialprogram')) {		
					$textcontent[] = array(
					'name'	   => 'Социальные программы',
					'href'     => $this->url->link('catalog/socialprogram', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);					
				}
				...
				*/
				...
				if ($this->user->hasPermission('access', 'module/redirect_manager')) {
					$seo[] = array(
					'name'	   => "Управление редиректами",
					'href'     => $this->url->link('module/redirect_manager', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				
				if ($this->user->hasPermission('access', 'module/seogen')) {
					$seo[] = array(
					'name'	   => "Генератор тегов",
					'href'     => $this->url->link('module/seogen', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				
				if ($this->user->hasPermission('access', 'extension/module/tltmultilang')) {
					$seo[] = array(
					'name'	   => "Мета для Домашней страницы",
					'href'     => $this->url->link('extension/module/tltmultilang', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				
				if ($this->user->hasPermission('access', 'extension/module/metaseo_anypage')) {
					$seo[] = array(
					'name'	   => 'Мета для служебных страниц',
					'href'     =>  $this->url->link('extension/module/metaseo_anypage', 'token=' . $this->session->data['token'], true),
					'children' => array()
					);
				}
				...
				if ($this->user->hasPermission('access', 'marketing/indexer')) {
					$seo[] = array(
					'name'	   => "Indexing API Статистика",
            ...
            $sale[] = array(
				...
				if ($this->user->hasPermission('access', 'extension/module/IMCallMeAskMe')) {
					$sale[] = array(
					'name'	   => 'Обратные звонки',
					'href'     => $this->url->link('extension/module/IMCallMeAskMe', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				...
				if ($this->user->hasPermission('access', 'catalog/ochelp_special')) {
					$marketing[] = array(
					'name'	   => 'Промоакции',
					'href'     => $this->url->link('catalog/ochelp_special', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				
				if ($this->user->hasPermission('access', 'extension/module/xdstickers')) {
					$marketing[] = array(
					'name'	   => 'Управление стикерами',
					'href'     => $this->url->link('extension/module/xdstickers', 'token=' . $this->session->data['token'], true),
					'children' => array()		
					);	
				}
				...
				if ($this->user->hasPermission('access', 'setting/nodes')) {
					$exchange[] = array(
					'name'	   => "Точки обмена",
