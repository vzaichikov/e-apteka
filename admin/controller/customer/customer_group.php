...
class ControllerCustomerCustomerGroup extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$pricegroups = $this->model_catalog_pricegroup->getPriceGroupsForCustomerGroup($result['customer_group_id']);
	...
	protected function getForm() {			
		...
		if (isset($this->request->get['customer_group_id'])) {
			$this->model_customer_customer_group->prepareCustomerGroupData($this->request->get['customer_group_id']);
		}
		...
		if (isset($this->request->post['uuid'])) {
			...
			$data['uuid'] = $customer_group_info['uuid'];
		} else {
			$data['uuid'] = '';
		}
		...
		if (isset($this->request->post['customer_group_price_group'])) {
			$data['customer_group_price_group'] = $this->request->post['customer_group_price_group'];
		} elseif (isset($this->request->get['customer_group_id'])) {
			$data['customer_group_price_group'] = $this->model_catalog_pricegroup->getPriceGroupsForCustomerGroup($this->request->get['customer_group_id']);
		} else {
			$data['customer_group_price_group'] = array();
		}
