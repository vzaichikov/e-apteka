	...
	class ControllerSettingSetting extends Controller {
        ...
        $data['help_key'] = $this->language->get('help_key'); 
			...
			foreach ($data['languages'] as $language){
				if (isset($this->request->post['config_address_' . $language['language_id']])) {
					$data['config_address_' . $language['language_id']] = $this->request->post['config_address_' . $language['language_id']];
					} else {
					$data['config_address_' . $language['language_id']] = $this->config->get('config_address_' . $language['language_id']);
				}
			}
			...
			if (isset($this->request->post['config_free_shipping'])) {
				$data['config_free_shipping'] = $this->request->post['config_free_shipping'];
				} else {
			...
			if (isset($this->request->post['config_mailgun_api_key'])) {
				$data['config_mailgun_api_key'] = $this->request->post['config_mailgun_api_key'];
				} else {
				$data['config_mailgun_api_key'] = $this->config->get('config_mailgun_api_key');
			}
