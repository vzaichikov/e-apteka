...
class ControllerExtensionDashboardChart extends Controller {
	...
	public function chart() {
		...
		switch ($range) {
			default:
			case 'day':
				$results = $this->model_report_sale2->getTotalOrdersByDay();
				...
				break;
			case 'week':
				$results = $this->model_report_sale2->getTotalOrdersByWeek();
				...
				break;
			case 'month':
				$results = $this->model_report_sale2->getTotalOrdersByMonth();
				...
				break;
			case 'year':
				$results = $this->model_report_sale2->getTotalOrdersByYear();
