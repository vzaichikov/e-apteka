...
define('MOD_ACTIVE',                true);
	...
	define('EXTENSION_STORE_URL',       'http://feofan.net');
	define('EXTENSION_PURCHASE_URL',    'http://feofan.net');
	define('EXTENSION_SUPPORT_EMAIL',   'info@opencart2x.ru');
	define('EXTENSION_SUPPORT_FORUM',   'http://feofan.net');
	define('OTHER_EXTENSIONS',          'http://feofan.net');
	...
	class ControllerExtensionModuleAdminQuickEdit extends Controller {
		...
		'uuid'               => array('display' => 0, 'qe_status' => 0, 'editable' => 1, 'index' => 140, 'align' =>   'text-left', 'type' =>         'qe', 'sort' => 'p.uuid'         , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 0, 'autocomplete' => array('return' => array('label' =>   'uuid', 'value' => 'product_id')))),
		...
		'has_dl_price'        => array('display' => 1, 'qe_status' => 1, 'editable' => 1, 'index' => 350, 'align' => 'text-center', 'type' =>  'status_qe', 'sort' => 'p.has_dl_price'        , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
		'dl_price'             => array('display' => 1, 'qe_status' => 1, 'editable' => 0, 'index' =>  350, 'align' =>  'text-right', 'type' =>   'price_qe', 'sort' => 'p.dl_price'         , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
	...
	//	'seo_name'          => array('display' => 1, 'qe_status' => 1, 'editable' => 1, 'index' =>  22, 'align' =>   'text-left', 'type' =>     'seo_name_qe', 'sort' =>       'seo_name', 'filter' => array('show' => 0, 'type' => 0, 'autocomplete' => false)),
