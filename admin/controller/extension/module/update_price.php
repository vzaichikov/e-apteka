...
class ControllerExtensionModuleUpdatePrice extends Controller {
	...
	public function index() {
		$this->load->language('extension/module/update_price');
		...
		$data['action'] = $this->url->link('extension/module/update_price', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('extension/module/update_price', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/update_price')) {
