...
class ControllerExtensionModuleBanner extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['width_mobil'])) {
			$data['width_mobil'] = $this->request->post['width_mobil'];
		} elseif (!empty($module_info)) {
			$data['width_mobil'] = $module_info['width_mobil'];
		} else {
			$data['width_mobil'] = 130;
		}

		if (isset($this->request->post['height_mobil'])) {
			$data['height_mobil'] = $this->request->post['height_mobil'];
		} elseif (!empty($module_info)) {
			$data['height_mobil'] = $module_info['height_mobil'];
		} else {
			$data['height_mobil'] = 100;
		}
		
		if (isset($this->request->post['random'])) {
			$data['random'] = $this->request->post['random'];
		} elseif (!empty($module_info)) {
			$data['random'] = $module_info['random'];
		} else {
			$data['random'] = '';
		}
