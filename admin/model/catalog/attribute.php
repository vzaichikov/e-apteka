...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
		...
		foreach ($data['attribute_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description SET attribute_id = '" . (int)$attribute_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', 1c_name = '" . $this->db->escape($value['1c_name']) . "'");
		}
	...
	public function getAttributeBySyncID($sync_id) {
		$query = $this->db->query("SELECT attribute_id FROM '" . DB_PREFIX . "attribute_description WHERE 1c_name = '" . $this->db->query($sync_id) . "'");
	...
	public function getAttributeDescriptions($attribute_id) {
		...
		foreach ($query->rows as $result) {
			$attribute_data[$result['language_id']] = array('name' => $result['name'], '1c_name' => $result['1c_name']);
		}
