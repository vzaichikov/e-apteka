...
class ModelExtensionFeedGoogleBase extends Model {
    ...
    public function getGoogleBaseCategories($data = array()) {
	 ...
	 public function getGoogleBaseCategoryName($google_base_category_id) {
        $sql = "SELECT * FROM `" . DB_PREFIX . "google_base_category` WHERE google_base_category_id = '" . (int)$google_base_category_id . "' LIMIT 1";
