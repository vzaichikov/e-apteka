<?php
	class ModelLocalisationLocation extends Model {
		public function addLocation($data) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "location SET name = '" . $this->db->escape($data['name']) . "', address = '" . $this->db->escape($data['address']) . "', geocode = '" . $this->db->escape($data['geocode']) . "', gmaps_link = '" . $this->db->escape($data['gmaps_link']) . "', brand = '" . $this->db->escape($data['brand']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', image = '" . $this->db->escape($data['image']) . "', city = '" . $this->db->escape($data['city']) . "', city_id = '" . $this->db->escape($data['city_id']) . "', open = '" . $this->db->escape($data['open']) . "', open_struct = '" . $this->db->escape($data['open_struct']) . "', node_id = '" . (int)$data['node_id'] . "', is_stock = '" . (int)$data['is_stock'] . "', can_sell_drugs = '" . (int)$data['can_sell_drugs'] . "', can_free_stocks = '" . (int)$data['can_free_stocks'] . "', can_send_np = '" . (int)$data['can_send_np'] . "', temprorary_closed = '" . (int)$data['temprorary_closed'] . "', information_id = '" . (int)$data['information_id'] . "', default_price = '" . (int)$data['default_price'] . "', sort_order = '" . (int)$data['sort_order'] . "', delivery_times = '" . $this->db->escape($data['delivery_times']) . "', comment = '" . $this->db->escape($data['comment']) . "', uuid = '" . $this->db->escape($data['uuid']) . "'");
		...
		public function editLocation($location_id, $data) {
			$this->db->query("UPDATE " . DB_PREFIX . "location SET name = '" . $this->db->escape($data['name']) . "', address = '" . $this->db->escape($data['address']) . "', geocode = '" . $this->db->escape($data['geocode']) . "', gmaps_link = '" . $this->db->escape($data['gmaps_link']) . "', brand = '" . $this->db->escape($data['brand']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', image = '" . $this->db->escape($data['image']) . "', open = '" . $this->db->escape($data['open']) . "', city = '" . $this->db->escape($data['city']) . "', city_id = '" .  $this->db->escape($data['city_id']) . "', open_struct = '" . $this->db->escape($data['open_struct']) . "', node_id = '" . (int)$data['node_id'] . "', is_stock = '" . (int)$data['is_stock'] . "', can_sell_drugs = '" . (int)$data['can_sell_drugs'] . "', can_free_stocks = '" . (int)$data['can_free_stocks'] . "', can_send_np = '" . (int)$data['can_send_np'] . "', temprorary_closed = '" . (int)$data['temprorary_closed'] . "', information_id = '" . (int)$data['information_id'] . "', default_price = '" . (int)$data['default_price'] . "', sort_order = '" . (int)$data['sort_order'] . "', delivery_times = '" . $this->db->escape($data['delivery_times']) . "', comment = '" . $this->db->escape($data['comment']) . "', uuid = '" . $this->db->escape($data['uuid']) . "' WHERE location_id = '" . (int)$location_id . "'");
