...
// Text
$_['text_module']       	= 'Модулi';
$_['text_extension']   		= 'Модулi';
...
// Settings
$_['settings_main'] 		= 'Основні налаштування';
$_['settings_sms']	 		= 'Налаштування SMS';
$_['settings_analytics'] 	= 'Налаштування аналітики';

// Fields
$_['field1_title'] 			= 'Iм\'я';
$_['field2_title'] 			= 'Телефон';
$_['field3_title'] 			= 'E-mail';
$_['field4_title'] 			= 'Коментар';
...
$_['text_stock_warning']		= 'Виводити попередження про відсутність товару';
...
$_['entry_status_product'] 		= 'Швидке замовлення в картці товару';
$_['entry_status_category'] 	= 'Швидке замовлення в категории, поиске, производителях и акциях';
$_['entry_status_module'] 		= 'Швидке замовлення в стандартных модулях';
$_['entry_style_status'] 		= 'Использовать стили buyoneclick.css';
$_['entry_option_status'] 		= 'Валидация обязательных опций';

// SMS.ru
$_['smsru_form_title'] 					= 'Настройка <strong>SMS</strong>.ru';
$_['smsru_form_subtitle']				= '<a href="//ocshop.sms.ru/" target="_blank">Регистрация</a> | <a href="//ocshop.sms.ru/price" target="_blank">Тарифы</a>';
...
// Extended analytics
$_['exan_form_title'] 					= 'Налаштування <strong><span style="color:green;">Расширенной</span></strong> аналитики';
$_['exan_status_title']					= 'Увімкнути расширенную аналитику';
...
$_['ya_identificator_title']			= 'Ідентифікатор цілі для кнопки &laquo;Быстрый заказ&raquo;';
$_['ya_identificator_send_title']		= 'Ідентифікатор цілі для кнопки &laquo;Отправить&raquo; формы быстрого заказа';
$_['ya_identificator_success_title']	= 'Ідентифікатор цілі при успешной отправке формы быстрого заказа';
$_['ya_target_status_title']			= 'Увімкнути Яндекс ціль';

// Google
$_['google_form_title'] 				= 'Налаштування <strong><span style="color:#4285f4;">G</span><span style="color:#ea4335;">o</span><span style="color:#fbbc05;">o</span><span style="color:#4285f4;">g</span><span style="color:#34a853;">l</span><span style="color:#ea4335;">e</span></strong> цілі';
...
$_['google_category_send_title']		= 'Категория для кнопки &laquo;Отправить&raquo; формы быстрого заказа';
$_['google_action_send_title']			= 'Действие для кнопки &laquo;Отправить&raquo; формы быстрого заказа';
...
$_['text_tab_help']						= 'Допомога';
$_['text_tab_help_title']				= 'Потрібна допомога?';
