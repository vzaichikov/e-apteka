...
$_['entry_announced_price_default']			 = 'Оголошена вартість за замовчуванням';
...
$_['help_key_api'] 							 = 'Вставте значення ключа API, який Ви можете знайти на сайті компанії «Нова Пошта» у власному кабінеті. Дивіться розділ Налаштування 🠆 API 2.0';
...
$_['help_announced_price_default']			 = 'Значення буде використано якщо оголошена вартість не задана або оплата по замовленню не накладеним платежем';
...
$_['help_payer']              				 = 'Вкажіть платника за замовчуванням';
