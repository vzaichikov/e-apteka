<?php
// Heading
$_['heading_title']    = 'Eapteka Deals';
$_['heading_title_so']    = 'Eapteka Deals <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 2.1.0</b>';
