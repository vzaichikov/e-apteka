...
// Heading
$_['heading_title']    = 'Eapteka Latest Blog';
$_['heading_title_so']    = 'Eapteka Latest Blog <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 1.0.7</b>';
