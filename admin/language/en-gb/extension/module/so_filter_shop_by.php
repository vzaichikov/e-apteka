<?php
// Heading
$_['heading_title']    		= 'Eapteka Filter Shop By';
$_['heading_title_so']    	= 'Eapteka Filter Shop By <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 2.1.2</b>';
