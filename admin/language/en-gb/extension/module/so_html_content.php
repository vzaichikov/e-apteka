<?php
// Heading
$_['heading_title']    		= 'Eapteka Html Content';
$_['heading_title_so']    	= 'Eapteka Html Content <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 1.1.0</b>';
