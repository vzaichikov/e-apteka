				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-store">
							...
							<?php foreach ($languages as $language) { ?>
								<div class="form-group required">
									...
									<div class="col-sm-10">
										...
										<textarea name="config_address_<?php echo $language['language_id']; ?>" placeholder="<?php echo $entry_address; ?>" rows="5" id="input-address" class="form-control"><?php echo ${'config_address_' . $language['language_id']}; ?></textarea>									
									</div>
								</div>	
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-free_shipping"><span data-toggle="tooltip" data-container="#tab-general" title="Бесплатная доставка по Киеву, от">Бесплатная доставка по Киеву, от</span></label>
								<div class="col-sm-10">
									<input type="text" name="config_free_shipping" value="<?php echo $config_free_shipping; ?>" placeholder="450" id="input-free_shipping" class="form-control" />
								</div>
							</div>
							<div class="form-group required">
								...
								<div class="col-sm-10">				  
									...
									<?php foreach ($languages as $language) { ?>
										<?php if ($language['code'] == $config_language) { ?>
											<input type="hidden" name="config_language_id" value="<?php echo $language['language_id']; ?>" />
											<?php } else { ?>
											<? continue; ?>
										<?php } ?>
									<?php } ?>
									...
									<select name="config_language" id="input-language" class="form-control">
										<?php foreach ($languages as $language) { ?>
											<?php if ($language['code'] == $config_language) { ?>
												<option value="<?php echo $language['code']; ?>" data-language-id="<?php echo $language['language_id']; ?>" selected="selected"><?php echo $language['name']; ?></option>
												<?php } else { ?>
												<option value="<?php echo $language['code']; ?>" data-language-id="<?php echo $language['language_id']; ?>"><?php echo $language['name']; ?></option>
											<?php } ?>
										<?php } ?>
									</select>
								</div>
						...
						<div class="tab-pane" id="tab-mail">
							<fieldset>
									...
									<div class="col-sm-10">
										<select name="config_mail_protocol" id="input-mail-protocol" class="form-control">
											...
											<?php if ($config_mail_protocol == 'mailgun') { ?>
												<option value="mailgun" selected="selected">MailGun API</option>
												<?php } else { ?>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-mailgun-api-key">MailGun api key</label>
									<div class="col-sm-10">
										<input type="text" name="config_mailgun_api_key" value="<?php echo $config_mailgun_api_key; ?>" placeholder="fbf29f936c432ae7c48e60c131fe77e7-0470a1f7-cf3de6eb" id="input-mailgun-api-key" class="form-control" />
									</div>
								</div>
								<div class="form-group">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-alert-email"><span data-toggle="tooltip" title="<?php echo $help_mail_alert_email; ?>"><?php echo $entry_mail_alert_email; ?></span></label>
									<div class="col-sm-10">
