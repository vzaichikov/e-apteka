          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
				<td class="text-left">
					<? if ($customer['is_bot']) { ?>
						<span class="label label-danger"><i class="fa fa-google" aria-hidden="true"></i></span>
					<? } else { ?>
						<span class="label label-success"><i class="fa fa-user" aria-hidden="true"></i></span>
					<? } ?>
				</td>
                <td class="text-left"><a href="http://whatismyipaddress.com/ip/<?php echo $customer['ip']; ?>" target="_blank"><?php echo $customer['ip']; ?></a></td>
				<td class="text-left"><?php echo $customer['useragent']; ?></td>
