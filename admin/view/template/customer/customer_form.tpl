            ...
            <script type="text/javascript">
                jQuery(function(){
                    ...
                    jQuery('#simple_custom_customer').load('index.php?option=com_mijoshop&format=raw&tmpl=component&route=extension/module/simple/custom&token=<?php echo $token; ?>&set=customer&object=customer&id=<?php echo $customer_id; ?>');
					  ...
					  <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-card">Карта</label>
                        <div class="col-sm-10">
                          <input type="text" name="card" value="<?php echo $card; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-card" class="form-control" />
                        </div>
                      </div>
					   <div class="form-group">
