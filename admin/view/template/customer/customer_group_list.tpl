              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'cgd.name') { ?>
				   ...
				   <td class="text-right">Ценовая политика</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer_group['name']; ?></td>
				   <td class="text-left"><?php echo $customer_group['uuid']; ?></td>
				  <td class="text-left" style="font-size:10px;">
					<?php foreach ($customer_group['pricegroups'] as $pricegroup) { ?>
						<? if ($pricegroup['percent'] > 0) {  ?>
							<? echo $pricegroup['pg_name']; ?>: <? echo $pricegroup['plus']?'+':'-' ?><? echo $pricegroup['percent'] ?>%<br />
						<? } ?>
					<? } ?>
				  </td>
