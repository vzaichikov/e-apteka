...
<div id="content">
                                ...
                                <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $entry_link; ?>, фон блока</td>
                                            <td class="text-left">Отображение, GA</td>
                                            <td class="text-center"><?php echo $entry_image; ?> <i class="fa fa-desktop" aria-hidden="true"></i></td>
                                            <td class="text-center"><?php echo $entry_image; ?> <i class="fa fa-mobile" aria-hidden="true"></i></td>
                                            <td class="text-right">Сорт</td>
                                        ...
                                        <?php if (isset($banner_images[$language['language_id']])) { ?>
                                            <?php foreach ($banner_images[$language['language_id']] as $banner_image) { ?>
                                                <tr id="image-row<?php echo $image_row; ?>">
                                                    ...
                                                    <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][link]" value="<?php echo $banner_image['link']; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" /><br />
                                                    
                                                    <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][background]" value="<?php echo $banner_image['background']; ?>" placeholder="#FFFFFF" class="form-control" />
                                                    
                                                    </td>
                                                    
                                                    <td class="text-left" style="width: 30%;">
                                                        <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][url]" value="<?php echo $banner_image['url']; ?>" placeholder="/home/url;/home;" class="form-control" /><br />
                                                        
                                                        <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][text1]" value="<?php echo $banner_image['text1']; ?>" placeholder="DUREX_PROMO_BANNER" class="form-control" /><br />
                                                    ...
                                                    <td class="text-center">
                                                        <a href="" id="thumb-image_mobil-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['thumb_mobil']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                                        <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][image_mobil]" value="<?php echo $banner_image['image_mobil']; ?>" id="input-image_mobil<?php echo $image_row; ?>" />
                                                    </td>
                                                    
                                                    <td class="text-right" style="width: 50px;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
    ...
    <script type="text/javascript"><!--
        ...
        function addImage(language_id) {
            ...
            html += '  <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /> <input type="text" name="banner_image[' + language_id + '][' + image_row + '][background]" value="" placeholder="#FFFFF" class="form-control" /></td>';
            
            html += '<td class="text-left" style="width: 30%;"> ';
            html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][url]" value="" placeholder="/home/url;/home;" class="form-control" />';	
            html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text1]" value="" placeholder="текст для баннера 1" class="form-control" />';	
            html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text2]" value="" placeholder="текст для баннера 2" class="form-control" />';	
            html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text3]" value="" placeholder="текст для баннера 3" class="form-control" />';	
            html += '</td>';	
