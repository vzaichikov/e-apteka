	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-user"></i> Получатель</h3>
					</div>
					<table class="table">
						<tr>
							<td style="width: 1%;"><button data-toggle="tooltip" title="<?php echo $text_customer; ?>" class="btn btn-info btn-xs"><i class="fa fa-user fa-fw"></i></button></td>
						...
						<tr>
							<td><button data-toggle="tooltip" title="<?php echo $text_telephone; ?>" class="btn btn-info btn-xs"><i class="fa fa-phone fa-fw"></i></button></td>
							<td><?php echo $fax?$fax:$telephone; ?></td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<table class="table table-bordered">
					<thead>
						<tr>
							<td style="width: 50%;" class="text-left">Клиент</td>
							<?php if ($shipping_method) { ?>
								<td style="width: 50%;" class="text-left">Получатель</td>
							<?php } ?>
						</tr>
					</thead>
					<tbody>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<?php foreach ($totals as $total) { ?>
							<tr>
								<td colspan="<? if ($need_location) { ?>4<? } else { ?>3<? } ?>" class="text-right"><?php echo $total['title']; ?></td>
