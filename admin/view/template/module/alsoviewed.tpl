...
<div id="content">
 <div class="page-header">
    <div class="container-fluid">
      <h1><i class="fa fa-eye-slash"></i>&nbsp;<?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
       ...
       <?php if ($error_warning) { ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>&nbsp;<span style="vertical-align:middle;font-weight:bold;">Module Statistics</span></h3>
                    ...
                    <div class="form-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach ($stores  as $st) { ?>
                                <li><a href="index.php?route=module/alsoviewed&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
                            <?php } ?> 
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="tabbable">
                        <div class="tab-navigation form-inline">
                            <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
                                ...
                                <li id="mainSettingsTab"><a href="#main_statistics" data-toggle="tab"><i class="fa fa-random"></i>&nbsp; Usually Viewed Together</a></li>                               
                            </ul>
						...
						?>
                            <div id="main_statistics" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/alsoviewed/tab_statistics.php'); ?></div>
                            <div id="control_panel" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/alsoviewed/tab_panel.php'); ?></div>                          
                        </div> <!-- /.tab-content --> 
                    </div><!-- /.tabbable -->
                </form>
            </div> 
