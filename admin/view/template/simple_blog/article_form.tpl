        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <button type="button"  onclick="$('form').submit()" form="form-blog-article" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
                                 ...
                                 <div class="tab-content">
                                    <?php foreach ($languages as $language) { ?>
                                        <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                            ...
                                            <div class="form-group required">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span data-toggle="tooltip" title="Применение">Применение</label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <input type="text" name="article_description[<?php echo $language['language_id']; ?>][primenenie]" value="<?php echo isset($article_description[$language['language_id']]['primenenie']) ? $article_description[$language['language_id']]['primenenie'] : ''; ?>" class="form-control" />
        							            </div>
                                            </div>
                                            
                                            <div class="form-group required">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span data-toggle="tooltip" title="Тег">Тег</label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <input type="text" name="article_description[<?php echo $language['language_id']; ?>][tags]" value="<?php echo isset($article_description[$language['language_id']]['tags']) ? $article_description[$language['language_id']]['tags'] : ''; ?>" class="form-control" />
        							            </div>
                                            </div>
                                            
                                            <div class="form-group required">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_description; ?> верхнее</label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <textarea name="article_description[<?php echo $language['language_id']; ?>][description2]" id="description<?php echo $language['language_id']; ?>_2" class="form-control summernote"><?php echo isset($article_description[$language['language_id']]['description2']) ? $article_description[$language['language_id']]['description2'] : ''; ?></textarea>
                                                </div>
                                            </div>
