	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-special').submit() : false;"><i class="fa fa-trash-o"></i></button>
			</div>
	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-special">
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<?php } ?></td>
									<td class="center"><?php if ($sort == 'n.end') { ?>
							...
							<tbody>
								...
								<tr class="<?php echo $class; ?>">
									<td align="center">
										<?php if ($special['selected']) { ?>
										<input type="checkbox" name="selected[]" value="<?php echo $special['special_id']; ?>" checked="checked" />
										<?php } else { ?>
										<input type="checkbox" name="selected[]" value="<?php echo $special['special_id']; ?>" />
										<?php } ?>
									</td>
									<td class="center"><img src="<?php echo $special['image']; ?>" alt="<?php echo $special['title']; ?>" style="padding: 1px; border: 1px solid #DDD;" /></td>
									<td class="left"><?php echo $special['title']; ?></td>
									<td class="left"><?php echo $special['date_added']; ?></td>
									<td class="left">
										<?php if ($special['active_now']) {?>
											<span class="label label-success"><?php echo $special['date_end']; ?></span>
										<? } else { ?>
