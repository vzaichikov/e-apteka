                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-left" width="200px">Проблемы</td>
                                    <td class="text-left"><?php if ($sort == 'name') { ?>
                                        <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                                        <?php } else { ?>
                                        <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                                    <?php } ?></td>
                                    <td class="text-left">Фильтр</td>
                                    <td class="text-left">Страна</td>
                                    <td class="text-left">Товаров</td>
                                ...
                                <?php if ($manufacturers) { ?>
                                    <?php foreach ($manufacturers as $manufacturer) { ?>
                                        <tr>                  
                                            ...
                                            <?php } ?></td>
                                            <td class="text-left">
                                                <?php if($manufacturer['problems']) { ?>
                                                    <?php foreach ($manufacturer['problems'] as $problem) { ?>
                                                        <span class="text-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $problem; ?></span><br />
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                            <td class="text-left">
                                                ...
                                                <?php foreach ($languages as $language) { ?>
													<?php if (isset($manufacturer['descriptions'][$language['language_id']])) { ?>
														<div><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <b><?php echo $manufacturer['descriptions'][$language['language_id']]['name']; ?></b></div>
                                                    <?php } ?>
                                                <?php } ?>
                                             ...
                                             <td class="text-left">
                                                 <?php foreach ($languages as $language) { ?>
													<?php if (isset($manufacturer['descriptions'][$language['language_id']])) { ?>
														<div><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['country']; ?>" /> <small><?php echo $manufacturer['descriptions'][$language['language_id']]['alternate_name']; ?></small></div>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td class="text-left">
                                                 <?php foreach ($languages as $language) { ?>
													<?php if (isset($manufacturer['descriptions'][$language['language_id']])) { ?>
														<div><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['country']; ?>" /> <b><?php echo $manufacturer['descriptions'][$language['language_id']]['country']; ?></b></div>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                            <td class="text-left">
                                                <kbd><?php echo $manufacturer['total_products']; ?></kbd>
                                            </td>
                                            <td class="text-left"><span class="label label-info"><?php echo $manufacturer['uuid']; ?></span></td>
