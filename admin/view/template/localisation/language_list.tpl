            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'code') { ?>
                    ...
                    <?php } ?></td>
				   <td class="text-left">URL code</td>
				  <td class="text-left">HrefLang</td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-left"><?php echo $language['urlcode']; ?></td>
				  <td class="text-left"><?php echo $language['hreflang']; ?></td>
