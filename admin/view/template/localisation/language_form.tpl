		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-language" class="form-horizontal">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label required" for="input-urlcode">URL code</label>
						<div class="col-sm-10">
							<input type="text" name="urlcode" value="<?php echo $urlcode; ?>" id="input-urlcode" class="form-control" />          
						</div>
					</div> 
					<div class="form-group required">
						<label class="col-sm-2 control-label required" for="input-hreflang">HrefLang</label>
						<div class="col-sm-10">
							<input type="text" name="hreflang" value="<?php echo $hreflang; ?>" id="input-hreflang" class="form-control" />          
						</div>
					</div>  
