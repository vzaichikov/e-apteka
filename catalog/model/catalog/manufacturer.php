	...
	public function getManufacturers($data = array()) {
		if ($data) {
			...
			if (!empty($data['filter_country'])){
				...
				$sql .= " AND LOWER(TRIM(md.location)) LIKE '" . $this->db->escape(mb_strtolower(trim($data['filter_country']))) . "'";
