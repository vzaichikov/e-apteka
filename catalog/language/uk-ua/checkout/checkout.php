<?php
	...
	$_['text_selectlocation']				= '<kbd>Оберіть аптеку для самовивозу</kbd><br /><a href="%s" target="_blank" ><i class="fa fa-map-marker" aria-hidden="true"></i> <small>подивитись на мапі</small></a> ';
	...
	$_['entry_payment_address']					= 'Адреса платника';
	
	$_['entry_telephone_error']					= '<i class="fa fa-warning"></i> У вашому профілі на жаль, немає номера телефону! Будь ласка, <a href="%s">перейдіть до особистого кабінету</a> та вкажіть номер телефону. Дякуємо!';
