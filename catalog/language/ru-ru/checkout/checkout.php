...
$_['text_shopping_cart'] = 'Моя корзина';
...
$_['text_selectlocation']				= '<kbd>Выберите аптеку для самовывоза</kbd><br /><a href="%s" target="_blank" ><i class="fa fa-map-marker" aria-hidden="true"></i> <small>посмотреть на карте</small></a> ';
...
$_['entry_email_or_card']							= 'E-Mail или Номер дисконтной карты';
$_['entry_password']					= 'Пароль или Фамилия';
...
$_['entry_payment_address']					= 'Адрес плательщика';

$_['entry_telephone_error']					= '<i class="fa fa-warning"></i> В вашем личном профиле не задан номер телефона! Пожалуйста, <a href="%s">перейдите в личный кабинет</a> и укажите номер телефона. Спасибо!';
