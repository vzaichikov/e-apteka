<?php
	...
	$_['text_checkout_customer_login']   = 'Войти в кабинет';
	$_['text_checkout_customer_cancel']  = 'Отмена';
	$_['text_checkout_shipping_method']  = 'Как доставить';
	$_['text_checkout_payment_method']   = 'Как оплатить';
	$_['text_checkout_payment_address']  = 'Адрес оплаты';
	$_['text_checkout_shipping_address'] = 'Город';
	...
	$_['text_agree']                     = 'Подтверждая заказ, я принимаю условия  <a class="colorbox fancybox agree" href="%s" alt="%s"><b>%s</b></a>';
	$_['text_register_agree'] 			 = 'Регистрируясь, я принимаю условия <a class="colorbox fancybox agree" href="%s" alt="%s"><b>%s</b></a>';
	$_['text_agree_shoppica']            = 'Подтверждая заказ, я принимаю условия  <a class="s_main_color" rel="prettyPhoto[ajax]" href="%s&iframe=true" alt="%s"><b>%s</b></a>';
	...
	$_['text_proceed_payment']           = 'Секундочку.. Мы оформляем заказ и резервируем товар в аптеке.';
	$_['text_checkout_shipping_address'] = 'Город';
	...
	$_['text_delivery_to_ukraine_unavailable']              	 = '<i class="fa fa-exclamation-circle"></i> Доставка по Украине возможна только при сумме заказа от %s';
	
	//DATE TEXTS
	$_['text_chooseday'] 		= 'Выберите день доставки';
	$_['text_today'] 			= 'Сегодня';
	$_['text_nextday'] 			= 'Завтра';
	$_['text_afternextday'] 	= 'Послезавтра';
	
	$_['please_choose_drugstore'] 		= 'Выберите аптеку из списка';
	$_['no_drugstores'] 		= 'Товары доступны в разных аптеках';
	...
	$_['text_choosetime'] 		= 'Выберите время доставки';
	$_['text_time_1'] 			= 'Днем (10.00 - 14.00)';
	$_['text_time_2'] 			= 'Вечером (14.00 - 18.00)';
	$_['text_time_3'] 			= 'Поздним вечером (19.00 - 23.59)';
	
	$_['text_chooseriverside'] 		= 'Выберите берег Киева';
	$_['text_leftriverside'] 		= 'Левый берег';
	$_['text_rightriverside'] 		= 'Правый берег';

	$_['text_leftriverside_only'] 		= 'только левый берег';
	$_['text_rightriverside_only'] 		= 'только правый берег';
	
	$_['text_leftriverside_deferred'] 		= 'Левый берег (доставка в течении трех дней)';
	$_['text_rightriverside_deferred'] 		= 'Правый берег (доставка в течении трех дней)';
	...
	$_['error_no_shipping']              = 'Доставка по данному адресу временно недоступна!';
	$_['error_no_payment']               = 'Оплата по данному адресу временно недоступна!';
	...
	$_['error_no_payment']               = 'Мы не смогли подобрать подходящий способ оплаты. Возможно, вы пробуете заказать товары, в количестве, отсутствующем в аптечной сети.';
