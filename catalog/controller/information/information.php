	...
	public function index() {
		...
		if ($information_info) {
			...
			if ($this->config->get('hb_snippets_og_enable') == '1'){
				...
				$this->document->setOpengraph('og:url', $this->url->link('information/information', 'information_id=' .  $information_id));
				}
			...
			if ($this->config->get('hb_snippets_og_enable') == '1'){
				$this->document->setOpengraph('og:description', substr(strip_tags($this->data['description']),0,110));
			}
