...
class ControllerCheckoutSimpleCheckoutCustomer extends SimpleController {
    ...
    public function index() {
        ...
        $this->_templateData['text_filldata_from']           = $this->language->get('text_filldata_from');
        ...
        $this->_templateData['cart_has_drugs'] = $this->cart->getIfCartHasDrugs();
		$this->_templateData['cart_has_receipt'] = $this->cart->getIfCartHasReceipt();
