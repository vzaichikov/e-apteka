    ...
    */
    ...
    class ControllerCheckoutSimpleCheckout extends SimpleController {
        ...
        */
            ...
            if (!empty($this->request->post['shipping_method']) && $this->request->post['shipping_method'] != 'pickup.pickup'){
                unset($this->session->data['pickup_location_id']);
            }
            
            if (!empty($this->request->post['shipping_method']) && $this->request->post['shipping_method'] == 'pickup.pickup' && !empty($this->request->post['shipping']) && !empty($this->request->post['shipping']['location_id'])){
                $this->session->data['pickup_location_id'] = $this->request->post['shipping']['location_id'];
            }
