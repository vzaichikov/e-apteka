...
$('.go_to_search, .js_show_all').click(function () {
...
$(document).ready(function() {
	...
	if ($('.text-danger').length){
		$('.text-danger').each(function(idx, e) {
	...
	*/
	...
	$('#list-view').click(function() {
		...
		$('.product-category-list').addClass('product-category-list--list');
	...
	$('#grid-view').click(function() {
		...
		$('.product-category-list').removeClass('product-category-list--list');
