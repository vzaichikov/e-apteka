<?php if ($analogs):?>
    ...
    <div class="col-xs-12 clearfix module">
            <h3 class="modtitle" >
                <?php echo $tab_analogs; ?>
            </h3>
			<div class="products-category">
            <div class="analoguate-products products-list grid">
				<!-- Products list -->
	...
	jQuery(document).ready(function($) {
			$('.analoguate-products').owlCarousel2({
				pagination: false,
				center: false,
				nav: true,
				dots: false,
	...
	// ]]></script>
	<?php else:?>
	<div class="module analoguate-horizontal">
            <h3 class="modtitle"><?php echo $text_related; ?></h3>
            <div class="analoguate-products  <?php if(count($products) > 4) echo "analoguate-products-slider";?>">
				<!-- Products list -->
	...
	$(document).ready(function($) {
		$('.analoguate-products-slider').owlCarousel2({
			pagination: false,
			center: false,
			nav: true,
			dots: false,
