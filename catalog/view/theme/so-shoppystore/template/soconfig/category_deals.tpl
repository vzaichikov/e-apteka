					...
					<div class="right-block col-lg-8 col-md-6">
						<div class="caption">
						  ...
						  <div class="clearfix">
							...
							<button class="btn btn-default compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-refresh"></i></button>
						  </div>
					</div><!-- right block -->
				</div>	
			</div>
