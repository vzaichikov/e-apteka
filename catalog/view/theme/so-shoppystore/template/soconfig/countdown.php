...
<div class="countdown_box">
	<div class="countdown_inner" style="background-color:#ea3a3c;">
		<div class="title "><?php echo (isset($view_details) && $view_details != '' ? $view_details : 'This limited  offer ends in:'); ?></div>
		<script type="text/javascript">
			...
			$(document).ready(function(){
				$('.defaultCountdown-<?php echo $product['product_id']; ?>').TimeCircles({
					count_past_zero: true,
					circle_bg_color: "#666",
					time: {
						Days: {
							show: true,
							text: "<?php echo $label_day; ?>",
							color: "#FC6"
						},
						Hours: {
							show: true,
							text: "<?php echo $label_hour; ?>",
							color: "#9CF"
						},
						Minutes: {
							show: true,
							text: "<?php echo $label_minute; ?>",
							color: "#BFB"
						},
						Seconds: {
							show: true,
							text: "<?php echo $label_second; ?>",
							color: "#F99"
						}
					}
	...
	<div class="defaultCountdown-<?php echo $product['product_id']; ?>" data-date="<? echo date('Y-m-d H:i:s', strtotime($special_end_date)); ?>"></div>
