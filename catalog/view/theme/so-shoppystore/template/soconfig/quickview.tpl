                ...
                <div class="content-product-left class-honizol  col-sm-5">
                	...
                	<div class="large-image ">
                        ...
                        <div id="thumb-slider" class="owl-theme owl-loaded owl-drag <?php echo ((count($images) < 3 ) ? 'not_full_slider' : 'full_slider'); ?> ">
							<?php
								$firstimg = array('popup' => $popup,'thumb' => $popup);
							...
							<script type="text/javascript"><!--
								jQuery(function ($) {
									...
									$nav.each(function () {
										$(this).on("initialized.owl.carousel2", function () {
											if ($(".thumbnail", $(this)).length < 2) {
												$(".owl2-prev", $(this)).css("display", "none");
												$(".owl2-next", $(this)).css("display", "none");
											}
										});
