<?php if (!$ajaxed) { ?>
	...
	<? } ?>
	<a data-loading-text="<?php echo $text_loading; ?>" class="btn-group  dropdown-toggle" data-toggle="dropdown">
		<div class="shopcart">
	...
	<ul class="dropdown-menu pull-right shoppingcart-box">
		<?php if ($products || $vouchers) { ?>
			...
			<?php if(count($products) > 0) { ?>
				<li>
					<div class="added_items"><?php echo $text_unique_items; ?></div>
				</li>
			<? } ?>
			...
			<li>
				...
				<div class="checkout clearfix">
					...
					<a href="<?php echo $checkout; ?>" class="btn btn-checkout col-md-12"><?php echo $text_checkout; ?></a>
				</div>
			</li>
			<?php } else { ?>
			<li>
