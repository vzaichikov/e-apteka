<?php if (true) { ?>
	<div class="<?php echo $is_logged_in ? 'checkout-content' : ''; ?> checkout-<?php echo $type; ?>-form">
		<?php if (@$is_logged_in): ?>
		<h2 class="secondary-title"><i class="fa fa-map-marker"></i><?php echo $type === 'payment' ? $entry_payment_address : $entry_shipping_address; ?> </h2>
		<?php endif; ?>
		<div class="box-inner">
			<form class="form-horizontal form-<?php echo $type; ?>">
				...
				<div id="<?php echo $type; ?>-new" style="display: <?php echo($addresses ? 'none' : 'block'); ?>;">
					...
					<?php endif; ?>
					<div class="form-group company-input hidden">
					...
					<div class="form-group address-2-input hidden">
