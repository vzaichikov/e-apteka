  	...
  	<div class="row">
    	...
    	<div id="content" class="<?php echo $class; ?>">
    		...
    		<div class="so-onepagecheckout <?php if ($is_logged_in) echo 'is_customer'?> <?php echo ($setting_so_onepagecheckout_general['so_onepagecheckout_layout'] == 2 ? 'layout2' : '')?>">
				...
				<?php if ($is_logged_in && isset($entry_telephone_error)) { ?>
					<div class="row">
					<div class="col-sm-12 col-md-12">
						<div class=" alert alert-danger">
							<? echo $entry_telephone_error; ?>
						</div>
					</div>
				</div>
				<? } ?>
    	                        ...
    	                        <fieldset>
    	                            ...
    	                            <div class="box-inner">
                                        <div class="form-group">
        	                                <input type="text" name="login_email" value="" placeholder="<?php echo $entry_email_or_card; ?>" id="input-login_email" class="form-control" />
										</div>
        	                            <div class="form-group">
        	                                <input type="text" name="login_password" value="" placeholder="<?php echo $entry_password; ?>" id="input-login_password" class="form-control" />
