<div class="checkout-content checkout-register">
    <fieldset id="account">
        ...
        <div class="payment-new box-inner">
            ...
            <div class="form-group fax-input hidden">
		...
		<div class="box-inner">
			<div class="pretty p-default">		
				...
				<div class="state p-primary-o">
					<label style="padding:0px; width:auto; min-height:auto; height:auto; margin-bottom:0px;"><?php echo $entry_shipping; ?></label>
				</div>		
			</div>
		</div>
	</fieldset>
