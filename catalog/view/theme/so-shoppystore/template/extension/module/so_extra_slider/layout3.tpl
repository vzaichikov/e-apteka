									...
									<div class="item-content">
										...
										<?php if($display_addtocart || $display_readmore_link || $display_wishlist || $display_compare) { ?>
											<div class="button-container">
												...
												<button type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-refresh"></i></button>
												<?php } ?>
											</div>
										<?php } ?>
