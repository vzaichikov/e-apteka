		...
		<div class=" container-megamenu  <?php if($ustawienia['orientation'] == 1) { echo 'vertical '; } else { echo 'horizontal'; } ?>">
			<?php if($ustawienia['orientation'] == 1) { ?>
				...
				<style>
					...
					header .megamenu-style-dev .navbar-default .vertical .navbar-header .navbar-toggle::after{display: none;}
					}
					@media (max-width:779px){
						header.typeheader-4 .header-bottom .navbar-default{ background-color:transparent !important;}
					}
				</style>
				<div class="navbar-header">		
					...
					<span class="title-navbar hidden-lg hidden-md hidden-sm hidden-xs"><?php echo $navigation_text; ?></span>			
				</div>
				<?php } else { ?>
				<div class="navbar-header">
			...
			<?php if($ustawienia['orientation'] == 1) { ?>
				<div class="vertical-wrapper" aria-labelledby="menuHeading" <?php if ($is_homepage) { ?>style="display:block!important;"<? } ?>>
					<?php } else { ?>
