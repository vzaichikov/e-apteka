			...
			<div class="wap-listing-tabs products-list grid">
				...
				<div class="ltabs-items <?php echo $cls; ?>" data-total="<?php echo $items['count'] ?>">
					...
					if (!empty($child_items)) {	
						if (file_exists(DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/extension/module/so_listing_tabs/home7/default_items.tpl')) {
							include (DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/extension/module/so_listing_tabs/home7/default_items.tpl');
						}
						else {
