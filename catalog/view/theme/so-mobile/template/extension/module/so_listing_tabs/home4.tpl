	...
	<div id="<?php echo $tag_id; ?>" class="so-listing-tabs first-load module"><!--<![endif]-->
		...
		<div class="ltabs-wrap ">
			<div class="ltabs-tabs-container" data-delay="<?php echo $delay ?>"
				...
				<!--Begin Tabs-->
					<?php include("home4/default_tabs.tpl");	?>
			...
			<div class="wap-listing-tabs products-list grid">
				...
				<div class="ltabs-items <?php echo $cls; ?>" data-total="<?php echo $items['count'] ?>">
					...
					if (!empty($child_items)) {	
						if (file_exists(DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/extension/module/so_listing_tabs/home4/default_items.tpl')) {
							include (DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/extension/module/so_listing_tabs/home4/default_items.tpl');
						}
						else {
							include("home4/default_items.tpl");
						}	
