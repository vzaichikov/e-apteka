			...
			<div class="product-thumb transition">
				...
				<div class="caption">
					<div class="item-time-w">
						<span class="icon-time"><?php echo  $objlang->get('text_time_left'); ?></span>
						<div class="item-time">						
				...
				<div class="product-layout product-thumb transition">
					<div class="row">
						<div class="item-left col-lg-6 col-md-6">
							<div class="image">
								<?php if ($product['special'] && $display_sale) : ?>
									<span class="label-product label-product-sale"><?php //echo $objlang->get('text_sale'); ?>
										<?php if(!isset($discount_status) || $discount_status) echo $product['discount']; ?>
									</span>
								<?php endif; ?>
								<?php if ($product['productNew'] && $display_new) : ?>
									<span class="label-product label-product-new"><?php echo $objlang->get('text_new'); ?></span>
								<?php endif; ?>
								<?php if($product_image) { ?>
									<a href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>" class="img-link">
										<?php if($product_image_num ==2){?>
											<img src="<?php echo $product['thumb']?>" class="img-thumb1 img-responsive" alt="<?php echo $product['name'] ?>">
											<img src="<?php echo $product['thumb2']?>" class="img-thumb2 img-responsive" alt="<?php echo $product['name'] ?>">
										<?php }else{?>
								 ...
								 <div class="button-group so-quickview">	
									<?php if($display_wishlist)
									{?>
										<button class="btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
									<?php
									}?>
									<?php if($display_compare)
									{?>
										<button class="btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
									<?php }?>
