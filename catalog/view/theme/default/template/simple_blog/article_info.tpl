...
<div class="container">
	<div class="row">
		...
		<?php if ($column_left && $column_right) { ?>
            ...
            <?php } else { ?>
			<?php $class = 'col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0'; ?>
		<?php } ?>
				...
				<?php if(isset($article_info_found)) { ?>
					<div class="article-info">
						...
						<div class="article-title">
							<!-- <span class="article-date" style="float:right;" ><?php echo $date_added;?></span> -->
							<h1><?php echo $article_info['article_title']; ?></h1>
						</div>

						<div class="article-pre-description">
							<?php echo html_entity_decode($article_info['description2'], ENT_QUOTES, 'UTF-8'); ?>
						</div>

						<?php if($image) { ?>
							<div style="height:400px; background-size: cover; background-position: center center; background-repeat: no-repeat; margin-bottom:20px; background-image:url(<?php echo $image; ?>)">
							</div>
						<?php } ?>							
						<!-- DESCRIP -->
						<?php if(isset($featured_found)) { ?>
							<div class="article-description information-text-style" style="clear: both;">
								<?php echo html_entity_decode($article_info['description'], ENT_QUOTES, 'UTF-8'); ?>
							</div>
    						<?php } else { ?>
							<div class="article-description information-text-style">
								<?php echo html_entity_decode($article_info['description'], ENT_QUOTES, 'UTF-8'); ?>
							</div>
						<?php } ?>
