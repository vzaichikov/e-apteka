  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td class="text-right"><a href="<?php echo $result['update']; ?>" class="bbtn"><?php echo $button_edit; ?></a> &nbsp; <a href="<?php echo $result['delete']; ?>" class="bbtn"><?php echo $button_delete; ?></a></td>
          </tr>
          <?php } ?>
        </table>
      </div>
      ...
      <div class="buttons clearfix">
        ...
        <div class="pull-right"><a href="<?php echo $add; ?>" class="bbtn"><?php echo $button_new_address; ?></a></div>
      </div>
