		...
		<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
				<fieldset id="account">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="tel" name="telephone" id="telephone" value="<?php echo $telephone; ?>" placeholder="+38(___)__-__-___<?php //echo $entry_telephone; ?>" id="input-telephone" class="form-control" />
          ...
          <script>
            $(document).ready(function () {
                $("#telephone").inputmask("+38(999)999-99-99")
            });
          </script>
							...
							<?php if ($custom_field['location'] == 'account') { ?>
								...
								<?php if ($custom_field['type'] == 'file') { ?>
									<div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
										<label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
										<div class="col-sm-10">
											<button type="button" id="button-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="bbtn"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
										...
										<div class="col-sm-10">
											<div class="input-group date">
												...
												<span class="input-group-btn">
													<button type="button" class="bbtn"><i class="fa fa-calendar"></i></button>
												</span></div>
												<?php if (isset($error_custom_field[$custom_field['custom_field_id']])) { ?>
													<div class="text-danger"><?php echo $error_custom_field[$custom_field['custom_field_id']]; ?></div>
												<?php } ?>
