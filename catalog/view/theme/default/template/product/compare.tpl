...
<div class="container">
	...
	<div class="row"><?php echo $column_left; ?>
		<?php if ($column_left && $column_right) { ?>
			...
			<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<div id="content" class="<?php echo $class; ?> information-text-style"><?php echo $content_top; ?>
					...
					<tr>
						...
						<?php foreach ($products as $product) { ?>
							<td class="text-center">
								<?php if ($product['quantity'] > 0) { ?>
									<input type="button" value="<?php echo $button_cart; ?>" class="bbtn  product-layout__btn-cart" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
								<?php } ?>
							<a href="<?php echo $product['remove']; ?>" class="bbtn"><?php echo $button_remove; ?></a></td>
						<?php } ?>
					</tr>
				</table>
				<?php } else { ?>
