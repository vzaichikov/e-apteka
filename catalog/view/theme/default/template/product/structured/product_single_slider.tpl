<div class="swiper-slide product-item product-single tmp_single_slider" data-product-id="<?php echo $product['product_id']; ?>" 
	data-gtm-product='{<?php foreach ($product['ecommerceData'] as $ecommerceKey => $ecommerceValue) { ?>"<?php echo $ecommerceKey; ?>": "<?php echo $ecommerceValue; ?>",<?php } ?> "url": "<?php echo $product['href']; ?>"}' style="width: 305.75px; margin-right: 10px;">
	...
	<div class="button-group">
		...
		<?php if($product['quantity'] > 0) { ?>
			<button class="bbtn bbtn-primary product-layout__btn-cart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');">
