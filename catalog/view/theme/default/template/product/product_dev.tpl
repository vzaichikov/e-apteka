...
<style>
	...
	@media screen and (max-width: 480px) {
		#tab-forms-of-release .product-category-list {
			display: block;
		}
	}
</style>
...
<div class="container">
	...
	<div class="product-tabs">
		...
		<div class="tab-content">				
			<div class="tab-pane active" id="tab-about-prod">						
				<div class="<?php if ($quantity_stock > 0) { ?>col-md-8<?php } else { ?>col-md-12<?php } ?> col-sm-12">
					<div class="row">
						<div class="<?php if ($quantity_stock > 0) { ?>col-sm-6<?php } else { ?>col-sm-2<?php } ?>">
							<?php if ($thumb || $images) { ?>
						...
						<div class="<?php if ($quantity_stock > 0) { ?>col-sm-6<?php } else { ?>col-sm-10<?php } ?>">	
								...
								<div class="product-info__col-content">
									...
									<?php if ($quantity_stock > 0) { ?>
										<?php if ($price) { ?>
											...
											<?php if ($free_shipping_kyiv) { ?>
												<div class="product__freedelivery-wrap row" style="margin:0px;">
													<div class="col-lg-7 col-md-7 col-sm-10 col-xs-12 pull-right alert alert-success">
							...
							<?php if ($quantity_stock > 0) { ?>	
								...
								<div class="product__text-row product__manufacturer row">
									<div class="col-sm-12 col-md-7">
										<code><?php echo $text_manufacturer; ?>
									...
									<?php if ($brand) { ?>
										<div class="col-sm-12 col-md-5">
											<code><?php echo $text_brand; ?> <?php echo $brand; ?></code>
										</div>
									<?php } ?>
								</div>
		...
		<?php if ( isset($description) && !empty($description) ) { ?>
			<div class="description-block" style="display: inline-block;margin: 25px 0;">
