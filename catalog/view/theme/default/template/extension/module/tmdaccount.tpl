<?php if($logged){ ?>
	<div class="profile">
		...
		<div class="detail">
			...
			<div class="row">
				<div class="col-sm-6">
				<a class="button" href="<?php echo $edit; ?>" data-toggle="tooltip" title="<?php echo $text_edit; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>	
				</div>
				<div class="col-sm-6">
				<a class="button" href="<?php echo $logout; ?>" data-toggle="tooltip" title="<?php echo $text_logout; ?>"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
				</div>
			</div>	
		</div>
	</div>
