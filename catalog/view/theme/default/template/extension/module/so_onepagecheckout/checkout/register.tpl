<div class="checkout-content checkout-register">
    <fieldset id="password" style="display: <?php echo ($setting_so_onepagecheckout_layout_setting['so_onepagecheckout_account_open'] == 'register' ? 'block' : 'none')?>">
        ...
        <h2 class="secondary-title"><i class="fa fa-lock"></i><?php echo $text_your_password; ?></h2>
        <?php }?>
        <div class="box-inner">
    ...
    <fieldset id="account">
        <h2 class="secondary-title"><i class="fa fa-user-plus"></i><?php echo $text_your_details; ?></h2>
                    ...
                    <?php if ($customer_group['customer_group_id'] == $customer_group_id) { ?>
                        <div class="radio">
                            <label class="radio__box-wrap">
                                <input type="radio" id="customer_group_id-<?php echo $customer_group['customer_group_id']; ?>" class="radio__input" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked"><span class="radio__box"></span>
                            </label>
                            <label for="customer_group_id-<?php echo $customer_group['customer_group_id']; ?>" class="radio__text"><?php echo $customer_group['name']; ?></label>
                        </div>
                    <?php } else { ?>
                        <div class="radio">
                            <label>
                                <input type="radio" id="customer_group_id-<?php echo $customer_group['customer_group_id']; ?>" class="radio__input" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>"><span class="radio__box"></span>
                            </label>
                            <label for="customer_group_id-<?php echo $customer_group['customer_group_id']; ?>" class="radio__text"><?php echo $customer_group['name']; ?></label>
                        </div>
                    <?php } ?>
                        ...
                        <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"
                            ...
                            <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
                                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                                    <div class="radio">
                                        <label class="radio__box-wrap">
                                            <input type="radio" id="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" class="radio__input" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>"><span class="radio__box"></span>
                                        <label for="<?php echo $type; ?>_address-2" class="radio__text"><?php echo $custom_field_value['name']; ?></label>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                                ...
                                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                                    <div class="checkbox">
                                        <label class="checkbox__box-wrap">
                                            <input type="checkbox" id="custom_field[<?php echo $custom_field['custom_field_id']; ?>][]" class="checkbox__input" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>][]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>"/><span class="checkbox__box"></span>
                                        <label for="<?php echo $type; ?>_address-2" class="checkbox__text"><?php echo $custom_field_value['name']; ?></label>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
    ...
    <fieldset id="address">
        <h2 class="secondary-title"><i class="fa fa-map-marker"></i><?php echo $text_your_address; ?></h2>
        <?php echo $payment_address_form; ?>
    </fieldset>
    <?php if (false): //($is_shipping_required): ?>
        <div class="checkbox check">
            <label class="check__box-wrap">
                <?php if ($shipping_address == '1'): ?>
                    <input type="checkbox" id="shipping_address" class="check__input" name="shipping_address" value="1" checked="checked" />
                <?php else: ?>
                    <input type="checkbox" id="shipping_address" class="check__input" name="shipping_address" value="0" />
                <?php endif; ?><span class="check__box"></span>
            </label>
            <label for="shipping_address" class="check__text"><?php echo $entry_shipping; ?></label>
            </label>
        </div>
        <br>
        <fieldset id="shipping-address" style="display: <?php echo $shipping_address == '1' ? 'none' : 'block'; ?>">
            <h2 class="secondary-title"><i class="fa fa-map-marker"></i><?php echo $text_shipping_address;?></h2>
