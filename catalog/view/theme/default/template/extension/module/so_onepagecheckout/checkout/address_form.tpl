            ...
            <?php if ($addresses) { ?>
                <div class="radio">
                    <label class="radio__box-wrap">
                        <input type="radio" id="<?php echo $type; ?>_address-1" class="radio__input" name="<?php echo $type; ?>_address" value="existing" checked="checked"><span class="radio__box"></span>
                    </label><label for="<?php echo $type; ?>_address-1" class="radio__text"><?php echo $text_address_existing; ?></label>
                </div>
                ...
                <div class="radio">
                    <label class="radio__box-wrap">
                        <input type="radio" id="<?php echo $type; ?>_address-2" class="radio__input" name="<?php echo $type; ?>_address" value="new"><span class="radio__box"></span>
                    </label><label for="<?php echo $type; ?>_address-2" class="radio__text"><?php echo $text_address_new; ?></label>
                </div>
            <?php } ?>
            <div id="<?php echo $type; ?>-new" style="display: <?php echo($addresses ? 'none' : 'block'); ?>;">
                <?php if ($name): ?>
                    <div class="form-group required">
                        <input type="text" name="<?php echo $type; ?>_firstname" value="<?php echo SoUtils::getProperty($order_data, $type . '_firstname'); ?> *" placeholder="<?php echo $entry_firstname; ?>" id="input-<?php echo $type; ?>-firstname" class="form-control" />
                    </div>
                    <div class="form-group required">
                        <input type="text" name="<?php echo $type; ?>_lastname" value="<?php echo SoUtils::getProperty($order_data, $type . '_lastname'); ?>" placeholder="<?php echo $entry_lastname; ?> *" id="input-<?php echo $type; ?>-lastname" class="form-control"/>
                    </div>
                <?php endif; ?>
                <div class="form-group company-input" style="display: none;">
                    <input type="text" name="<?php echo $type; ?>_company" value="<?php echo SoUtils::getProperty($order_data, $type . '_company'); ?>" placeholder="<?php echo $entry_company; ?>" id="input-<?php echo $type; ?>-company" class="form-control"/>
                </div>
                <div class="form-group required">
                    <input type="text" name="<?php echo $type; ?>_address_1" value="<?php echo SoUtils::getProperty($order_data, $type . '_address_1'); ?>" placeholder="<?php echo $entry_address_1; ?> *" id="input-<?php echo $type; ?>-address-1" class="form-control"/>
                </div>
                <div class="form-group address-2-input" style="display: none;">
                    <input type="text" name="<?php echo $type; ?>_address_2" value="<?php echo SoUtils::getProperty($order_data, $type . '_address_2'); ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-<?php echo $type; ?>-address-2" class="form-control"/>
                </div>
                <div class="form-group required">
                                    ...
                                    <div id="input-<?php echo $type; ?>-custom-field<?php echo $custom_field['custom_field_id']; ?>">
                                        <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                                            <div class="radio">
                                                <label class="radio__box-wrap">
                                                    <input type="radio"
                                                           id="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>]"
                                                           class="radio__input"
                                                           name="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>]"
                                                           value="<?php echo $custom_field_value['custom_field_value_id']; ?>"><span class="radio__box"></span>
                                                    </label><label for="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>]" class="radio__text"><?php echo $custom_field_value['name']; ?></label>
                                            </div>
                                        <?php } ?>
                                    </div>
                            </div>
                            ...
                            <div class="form-group<?php echo($custom_field['required'] ? ' required' : ''); ?> custom-field"
                                ...
                                <label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
                                    ...
                                    <div id="input-<?php echo $type; ?>-custom-field<?php echo $custom_field['custom_field_id']; ?>">
                                        <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                                            <div class="checkbox">
                                                <label class="checkbox__box-wrap">
                                                    <input type="checkbox"
                                                           id="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>][]"
                                                           class="checkbox__input"
                                                           name="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>][]"
                                                           value="<?php echo $custom_field_value['custom_field_value_id']; ?>"/><span class="checkbox__box"></span>
                                                </label><label for="<?php echo $type; ?>_custom_field[<?php echo $custom_field['custom_field_id']; ?>][]" class="check__text"><?php echo $custom_field_value['name']; ?></label>
                                            </div>
                                        <?php } ?>
                                    </div>
                            </div>
