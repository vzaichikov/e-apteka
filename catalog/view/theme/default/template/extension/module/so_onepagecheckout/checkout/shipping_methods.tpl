                            ...
                            <div class="radio">
                                <label class="radio__box-wrap">
                                    <?php if ($quote['code'] == $code ) { ?>
                                        <?php $code = $quote['code']; ?>
                                        <input type="radio" id="shipping_method-<?php echo $quote['code']; ?>" class="radio__input" name="shipping_method" value="<?php echo $quote['code']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                        <input type="radio" id="shipping_method-<?php echo $quote['code']; ?>" class="radio__input" name="shipping_method" value="<?php echo $quote['code']; ?>"/>
                                    <?php } ?>
                                    <span class="radio__box"></span>
                                </label><label for="shipping_method-<?php echo $quote['code']; ?>" class="radio__text"><?php echo $quote['title']; ?> - <?php echo $quote['text']; ?>
                                </label>
                            </div>
                        <?php }?>
                    <?php }?>
