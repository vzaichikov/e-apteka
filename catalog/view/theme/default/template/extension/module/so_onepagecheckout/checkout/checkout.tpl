                    ...
                    <div class="checkout-content login-box">
                        ...
                        <div class="radio">
                            <label class="radio__box-wrap">
                                <input type="radio" id="account-register" class="radio__input" name="account" value="register" <?php if ($default_auth === 'register'): ?> checked="checked" <?php endif; ?> /><span class="radio__box"></span>
                            <label for="account-register" class="radio__text"><?php echo $text_register; ?></label>
                        </div>
                        <?php if ($allow_guest_checkout) { ?>
                        <div class="radio">
                            <label class="radio__box-wrap">
                                <input type="radio" id="account-guest" class="radio__input" name="account" value="guest" <?php if ($default_auth === 'guest'): ?> checked="checked" <?php endif; ?>><span class="radio__box"></span>
                            <label for="account-register" class="radio__text"><?php echo $text_guest; ?></label>
                        </div>
                        <?php } ?>
                        <div class="radio">
                            <label class="radio__box-wrap">
                                <input type="radio" id="account-login" class="radio__input" name="account" value="login" <?php if ($default_auth === 'login'): ?> checked="checked" <?php endif; ?>><span class="radio__box"></span>
                            <label for="account-register" class="radio__text"><?php echo $text_returning_customer; ?></label>
                        </div>
                    </div>
                    <script>
                        ...
                        <div class="checkout-content confirm-section">
                            ...
                            <div class="radio check-privacy">
                                <label class="checkbox__box-wrap">
                                    <input type="checkbox" id="privacy-check" class="checkbox__input" name="privacy" value="1"><span class="checkbox__box"></span>
                                </label>
                                <label for="privacy-check" class="checkbox__text"><?php echo $text_privacy; ?></label>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="radio check-terms">
                                <label class="checkbox__box-wrap">
                                    <input type="checkbox" id="agree-check" class="checkbox__input" name="agree" value="1"><span class="checkbox__box"></span>
                                <label for="agree-check" class="checkbox__text"><?php echo $text_agree; ?></label>
                            </div>
                            <?php endif; ?>
