	...
	<ul class="catalog__list">
		<?php foreach ($categories as $category) { ?>
			...
			<?php if ($category['children']) { ?>
				...
				<li class="catalog__list-item has-children level_1"><a href="<?php echo $category['href']; ?>" class="catalog__list-link has-children"><?php echo $category_icon.$category['name'].$category_has_children_arrow; ?></a>
					<div class="topmenu">
						...
						<?php foreach ($category['children'] as $child) { ?>
								...
								<?php if ($child['children']) { ?>
									<li class="catalog__list-item has-children level_2"><a href="<?php echo $child['href']; ?>" class="catalog__list-link has-children"><?php echo $child['name'].$category_has_children_arrow; ?></a>
									...
									<?php } else { ?>
									<li class="catalog__list-item level_2"><a href="<?php echo $child['href']; ?>" class="catalog__list-link"><?php echo $child['name']; ?></a></li>
								<?php } ?>
