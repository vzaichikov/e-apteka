<?php
	...
	class Mail {
		...
		public function sendMailgun(){
			...
			$mgClient = new Mailgun('fbf29f936c432ae7c48e60c131fe77e7-0470a1f7-cf3de6eb');
			$domain = 'e-apteka.com.ua';
		...
		public function send() {
			...
			if (strpos($this->to, 'e-apteka.com.ua')){
				$this->protocol = 'smtp';				
			}				
